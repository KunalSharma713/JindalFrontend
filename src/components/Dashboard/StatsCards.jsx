...
import { Users, FolderOpen, DollarSign, Shield, TrendingUp, TrendingDown } from 'lucide-react'
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1 min-w-0">
                ...
                <div className="mt-3 flex items-center">
                  ...
                  <span className="ml-1 text-[10px] text-gray-500">from last month</span>
                </div>
              </div>
            </div>
          </div>

...
const PlantTable = ({
  ...
  const renderSortIcon = (key) => {
    if (sortConfig.key !== key) {
      return (
        <ChevronUp className="h-4 w-4 inline opacity-0 group-hover:opacity-100" />
      );
    }
              ...
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    <div className="flex items-center">
                      Code
                      <span className="ml-1">{renderSortIcon("code")}</span>
                    </div>
                  </th>
                  <th
                    scope="col"
                  ...
                  <tr key={warehouse._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-4 text-sm text-gray-500">
                      <div className="flex items-center">
                        ...
                        <span>
                          {formatCoordinates(warehouse.lat, warehouse.long)}
                        </span>
                      </div>
                    </td>
                    <td className="px-3 py-4 text-sm">
                      <span className={getStatusBadge(true)}>Active</span>
                    </td>
                  ...
                  <div>
                    <p className="text-sm text-gray-700">
                      ...
                      <span className="font-medium">
                        {Math.min(page * 10, warehouses.length)}
                      </span>{" "}
                      of{" "}

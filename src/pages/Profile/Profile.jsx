          ...
          <form onSubmit={passwordForm.handleSubmit(onPasswordSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`input-field ${passwordForm.formState.errors.currentPassword ? 'border-red-300' : ''}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`input-field ${passwordForm.formState.errors.newPassword ? 'border-red-300' : ''}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`input-field ${passwordForm.formState.errors.confirmPassword ? 'border-red-300' : ''}`}

            ...
            >
              <div className="p-4 sm:p-6">
                <div className="flex items-center">
                  <div className="flex-shrink-0 bg-primary-100 p-2 sm:p-3 rounded-full">
                    <Warehouse className="h-5 w-5 sm:h-6 sm:w-6 text-primary-600" />
                  </div>
                  <div className="ml-3 sm:ml-4 min-w-0">
                    <h3 className="text-base sm:text-lg font-medium text-gray-900 truncate">
                      {plant.warehouse_name}
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-500">{plant.code}</p>
                  </div>
                </div>
                {selectedPlant === plant._id && (
